...
![Pasted image 20260720165831.png](../images/Pasted%20image%2020260720165831.png)

Use this to make a 3d6 roll by clicking on it, or a 1d roll by right-clicking. If there are any [Modifiers](Navigating%20the%20UI%20%E2%9C%93.md#modifiers) in the Modifier Bucket, the die roll will be adjusted by the modifier total.
...
![Pasted image 20260720163413.png](../images/Pasted%20image%2020260720163413.png)

## Rollable Fields

Notice that the mouse is hovering over this character's IQ attribute and it is highlighted in a gold-orange color. This indicates that this attribute is rollable; clicking it will automatically make a GURPS success roll against this character's IQ and display the results in the chat bar (perhaps with a [Roll Confirmation](Settings%20Subpages/Miscellaneous%20Settings.md#show-confirmation-roll-dialog)  dialog).

In general, rollable fields (such as attributes) are highlighted in yellow.

![Pasted image 20260720163727.png](../images/Pasted%20image%2020260720163727.png)

If you get the Roll Confirmation dialog, click **Roll** to complete the roll or **Cancel**.

![Pasted image 20260720163949.png](../images/Pasted%20image%2020260720163949.png)
*Figure: The results of the roll is shown in the chat. Notice that the character's name, the type of roll (**vs IQ**), target (**10**),  individual dice (**2, 1, 1**), result (**Critical Success**) and margin of success (**6**) are all displayed.*

Skills and Spells are all augmented with rollable fields.
![Pasted image 20260720173832.png](../images/Pasted%20image%2020260720173832.png)
...
![Pasted image 20260720165301.png](../images/Pasted%20image%2020260720165301.png)
...
After clicking those penalties, you should see a total modifier of –3 in the [Modifier Bucket](Modifier%20Bucket.md) window near the bottom of the screen:
![Pasted image 20260720170530.png](../images/Pasted%20image%2020260720170530.png)
...
![Pasted image 20260720170618.png](../images/Pasted%20image%2020260720170618.png)
...
![Pasted image 20260720170800.png](../images/Pasted%20image%2020260720170800.png)
*Figure: It's nice to have a high skill!*
...
![Pasted image 20260720172253.png](../images/Pasted%20image%2020260720172253.png)
...
You can enable a quick edit ribbon on these components via the [Actor Settings > Enhanced Numeric Inputs](Settings%20Subpages/Actor%20Settings.md#enhanced-numeric-inputs) setting.
...
![Pasted image 20260720173209.png](../images/Pasted%20image%2020260720173209.png)
...
![Pasted image 20260720173636.png](../images/Pasted%20image%2020260720173636.png)
...
* [Modifier Bucket](Modifier%20Bucket.md)
* [Resource Tracker ✓](Resource%20Tracker%20%E2%9C%93.md)
* [Combat Tracker](Combat%20Tracker.md)
* [Apply Damage Dialog ✓](Apply%20Damage%20Dialog%20%E2%9C%93.md)
* [Effect Modifiers](Effect%20Modifiers.md) and [Tagged Modifier](Tagged%20Modifier.md)
* [Rollable Tables](Rollable%20Tables.md)
