...
![Pasted image 20260717175309.png](../../images/Pasted%20image%2020260717175309.png)
*Figure: Navigation Ribbon, shown.*

The navigation ribbon can be hidden or shown by clicking on the double arrows icon (»):
![Pasted image 20260717175616.png](../../images/Pasted%20image%2020260717175616.png)
*Figure: Navigation Ribbon, hidden.*

### Portrait HP Tinting

If checked, the Modern character sheet will show a red tint overlay to indicate relative HP loss for the character.
![Pasted image 20260717175946.png](../../images/Pasted%20image%2020260717175946.png)
*Figure: Character with no HP loss.*

![Pasted image 20260717180042.png](../../images/Pasted%20image%2020260717180042.png)
*Figure: Character with about 75% HP loss.*

![Pasted image 20260717180141.png](../../images/Pasted%20image%2020260717180141.png)
*Figure: Character at first death check.*
...
![Pasted image 20260717180832.png](../../images/Pasted%20image%2020260717180832.png)
*Figure: The Enhanced Numeric Input ribbon.*
...
![Pasted image 20260718141307.png](../../images/Pasted%20image%2020260718141307.png)
*Figure: "Backpack, Small" (and all the items inside it) is unequipped and will not be added to the current weight and encumbrance.*
...
![Pasted image 20260718141119.png](../../images/Pasted%20image%2020260718141119.png)
*Figure: Any attacks from "Broadsword" will not be listed since it is unequipped.*

### Display User-Created Flag

If checked, Equipment not imported from GCS/GCA will show a small flag.

![Pasted image 20260718140747.png](../../images/Pasted%20image%2020260718140747.png)
*Figure: The blue ribbon icon indicates that "Equipment..." was not imported.*

### Display Foundry Item Flag

If checked, show an icon next to an item (Trait, Skill, Spell, Equipment) that is a proper Foundry Item (see [Use Foundry Items for Player Data](Actor%20Settings.md#use-foundry-items-for-player-data)).

![Pasted image 20260718140747.png](../../images/Pasted%20image%2020260718140747.png)
*Figure: The star icon indicates that "Equipment..." is a Foundry Item.*
...
![Pasted image 20260718142301.png](../../images/Pasted%20image%2020260718142301.png)
*Figure: "Anti-Garrote Collar" was dragged from a GCS Equipment library that was imported into Foundry as a Compendium, as indicated by the book icon.*

### Display Quantity/Count Saved Flag

If checked, a small icon will appear after equipment where the Quantity and/or Count will be saved during imports. (See [Auto Save Foundry Quantity and Count](Actor%20Settings.md#auto-save-foundry-quantity-and-count)).

![Pasted image 20260718142900.png](../../images/Pasted%20image%2020260718142900.png)
*Figure: The "#" icon next to "Bodkin Point Arrow" indicates that the current quantity (11) will be saved during an import.*
...
![Pasted image 20260718143408.png](../../images/Pasted%20image%2020260718143408.png)
*Figure: Boomerang equipment has a Ranged Attack with a range of "x6/x10".*

![Pasted image 20260718143609.png](../../images/Pasted%20image%2020260718143609.png)
*Figure: After adding Boomerang with this setting checked, the calculated range will be displayed (ST 13 means 6x13 = 78 and 10x13 = 130).*
...
Allows you to create and apply standard [Resource Tracker ✓](../Resource%20Tracker%20%E2%9C%93.md) instances to character sheets. Resource trackers provide the user with a way to track non-standard values and pools such as Energy Reserve for the GURPS magic system or shield damage, etc.
...
*This functionality will eventually be replaced by implementing custom attributes in GGA v1.0+.*
