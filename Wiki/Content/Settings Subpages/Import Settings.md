The following controls how GGA [Import from GCA or GCS ✓](../Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md) works.
...
When [Import GCS Equipment](../Import%20GCS%20Equipment.md) compendium, the extended values for weight and cost will be imported. Check this if you don't want or need GGA to calculate the extended value.
...
*This setting is horribly misnamed.*
...
*This functionality will be replaced in GGA v1.0, where Foundry Items is the only data model.*
