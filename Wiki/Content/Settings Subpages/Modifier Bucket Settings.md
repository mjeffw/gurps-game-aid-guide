These settings handle how the [Modifier Bucket](../Modifier%20Bucket.md) is displayed and how it works.
...
![Pasted image 20260718145054.png](../../images/Pasted%20image%2020260718145054.png)
*Figure: Range Ruler making a measurement.*

![Pasted image 20260718145235.png](../../images/Pasted%20image%2020260718145235.png)
*Figure: The resulting range modifier added to the Modifier Bucket.*
...
Use this to select Journal Entries to show as a panel in the [Modifier Bucket](../Modifier%20Bucket.md) for a collection of custom modifiers.
