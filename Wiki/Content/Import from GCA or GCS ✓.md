As mentioned in [General Philosophy ✓](../General%20Philosophy%20%E2%9C%93.md), GGA versions prior to (the not yet released) v1.0.0 expect that you will create and maintain your characters in either GCS ([GURPS Character Sheet](https://gurpscharactersheet.com/)) or GCA ([GURPS Character Assistant](http://www.sjgames.com/gurps/characterassistant/)).
...
To use your characters in Foundry, it is best if you first create them in GCS or GCA, and then export them to Foundry. GMs can use the [Mook Generator ✓](Mook%20Generator%20%E2%9C%93.md) to create simple NPCs in Foundry.

## Settings

Some import functionality is configurable via [Import Settings](Settings%20Subpages/Import%20Settings.md).

## GCA

Creating a GGA character from a GCA file is multipart process:

* [Export the character data](Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md#export-from-gca) from GCA.
* [Create an Actor](Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md#create-an-actor).
* [Import from GCS or GCA](Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md#import-from-gcs-or-gca).
...
![Pasted image 20260720154642.png](../images/Pasted%20image%2020260720154642.png)
...
![Pasted image 20260720155001.png](../images/Pasted%20image%2020260720155001.png)
...
You can save the file anywhere, but check out [Special Export Location](Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md#special-export-location) for an added feature.
...
![Pasted image 20260720155610.png](../images/Pasted%20image%2020260720155610.png)

Click the Configure button and read the value of the **User Data Path** option.

![Pasted image 20260720155740.png](../images/Pasted%20image%2020260720155740.png)
...
![Pasted image 20260720153113.png](../images/Pasted%20image%2020260720153113.png)

Then click on the **Create Actor** button:
![Pasted image 20260720153151.png](../images/Pasted%20image%2020260720153151.png)

**Name** the actor and set the **Type**.
![Pasted image 20260720153251.png](../images/Pasted%20image%2020260720153251.png)

Generally, you should stick with type = "character". Entering the name at this point is optional if you are going to import from GCS/GCA as the character name may be overridden based on the value of setting [Import Settings > Ignore 'name' Attribute](Settings%20Subpages/Import%20Settings.md#ignore-name-attribute). Click the **Create** button. The default Actor sheet for this character will open.

![Pasted image 20260720153535.png](../images/Pasted%20image%2020260720153535.png)
*Figure: The empty Full (GCS) Actor sheet.*

![Pasted image 20260720153627.png](../images/Pasted%20image%2020260720153627.png)
*Figure: An empty Modern Actor sheet.*

# Import from GCS or GCA

Click the **Import** button in the titlebar of the Actor sheet window.
![Pasted image 20260720154117.png](../images/Pasted%20image%2020260720154117.png)
Click the **Choose File** button and select a GCS v5+ file *or* the GCA export file you created using the steps in [Import from GCA](Import%20from%20GCA%20or%20GCS%20%E2%9C%93.md#import-from-gca).
