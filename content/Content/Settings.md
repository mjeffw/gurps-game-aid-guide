...
Allows you to turn on or off an image associated with Traits, Skills, Spells, or Equipment on the character sheet. A cool way to show the image of a magic item directly on the sheet, for example.
